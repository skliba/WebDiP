...
$time = getPomak();
$uId = $_SESSION['userId'];
$upit = "insert into log values(default,'$uId', '$time', 'logout iz sustava', 1)";
$baza->updateDB($upit);
            ...
            <header id="zaglavlje">
                ...
                <div id="right">
                    <section id="sadrzaj">
                        ...
                        <h4>Odlogirat ćemo Vas sa stranice i proslijedit na stranicu za registraciju</h4>
                        <h4>Povratak na stranicu za registraciju za 3 sekunde</h4>
