...
if (isset($_SESSION['userType']) && $_SESSION['userType'] == 3) {
    ...
    $upit = "select postaja.id, postaja.naziv, postaja.adresa, postaja.valid, korisnik.username from postaja,korisnik where postaja.moderira = korisnik.id";
    ...
    $query = "insert into log values(default,'$log_user','$time','Neuspjeli pokušaj pristupa korisnika $arrayzsz[0] na stranicu stationList.php', 3)";
    $baza->updateDB($query);
            ...
            <div id="left">    
                <nav id="navigacija">
                    <ul>
                        ...
                        <li><a href="stationList.php" id="curr">Lista postaja</a></li>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(data).find('podaci').each(function () {
                            ...
                            red += "<td><a href='detalji_postaje.php?id=" + $(this).find('id').text() + "'>" + $(this).find('moderator').text() + "</a></td>";
